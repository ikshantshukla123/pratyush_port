      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            Hey there! I'm Pratyush Rohilla, a passionate Video Editor and Motion
            ...
            <GlassmorphismCard className="p-8">
              <div className="text-center">
                ...
                <div className="flex justify-center gap-4">
                  <a
                    href="https://www.linkedin.com/in/pratyush-rohilla-2263a2328?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                    target="_blank"
                  ...
                  <a
                    href=" https://www.instagram.com/pratyush__rohilla?igsh=MW1qYjdtNmE5dTRkcg%3D%3D&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://youtube.com/@pratyushrohilla?si=i20vkz3d-Ju3xRKd"
                    target="_blank"
                    rel="noopener noreferrer"
